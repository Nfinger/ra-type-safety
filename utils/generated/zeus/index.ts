    ...
    update_user_by_pk?: [
      {
        ...
        _inc?:
          | ValueTypes["user_inc_input"]
          | null /** sets the columns of the filtered rows to the given values */;
        _set?: ValueTypes["user_set_input"] | null;
...
export const TypesPropsResolver = ({
  ...
  console.log("🚀 ~ file: index.ts ~ line 908 ~ resolvedValue", resolvedValue);
  if (key) {
    console.log("🚀 ~ file: index.ts ~ line 999 ~ key", key);
...
export const Gql = Chain(
  "https://ra-workshop-type-safety.hasura.app/v1/graphql"
);
